...
function prepare_dragonboard_rootfs()
{
	if [ -d ${LICHEE_DRAGONBAORD_DIR} ]; then
		...
		mkdir -p ${LICHEE_TOP_DIR}/rootfile/rootfs/lib/modules/
		rm -rf ${LICHEE_TOP_DIR}/rootfile/rootfs/lib/modules/*
		#cp -rf ${KERNEL_STAGING_DIR}/lib/modules/* ${LICHEE_DRAGONBAORD_DIR}/rootfs/lib/modules/
		cp -rf ${KERNEL_STAGING_DIR}/lib/modules/* ${LICHEE_TOP_DIR}/rootfile/rootfs/lib/modules/
