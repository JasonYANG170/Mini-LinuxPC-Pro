...
{
	/* 
	 * Disable blanking for ST7789 to prevent black screen issues.
	 * Always keep display on regardless of blank request.
	 */
	dev_info(par->info->device, "ST7789: Blank request ignored (on=%d), keeping display on\n", on);
	
	/* Always send display ON command */
