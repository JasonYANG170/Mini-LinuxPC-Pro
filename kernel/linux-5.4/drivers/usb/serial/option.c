			...
			const struct usb_device_id *id)
{
    ...
    if (serial->dev->descriptor.idVendor == cpu_to_le16(0x1286) && serial->dev->descriptor.idProduct == cpu_to_le16(0x4e3d) && iface_desc->bInterfaceNumber <= 1)
                return -ENODEV;
            if (serial->dev->descriptor.idVendor == cpu_to_le16(0x1782) && serial->dev->descriptor.idProduct == cpu_to_le16(0x4e00) && iface_desc->bInterfaceNumber <= 1)
                return -ENODEV;
            if (serial->dev->descriptor.idVendor == cpu_to_le16(0x2ECC) && serial->dev->descriptor.idProduct == cpu_to_le16(0xA000) && iface_desc->bInterfaceNumber <= 1)
                return -ENODEV;
            if (serial->dev->descriptor.idVendor == cpu_to_le16(0x19d1) && serial->dev->descriptor.idProduct == cpu_to_le16(0x0001) && iface_desc->bInterfaceNumber <= 1)
                return -ENODEV;
